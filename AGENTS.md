...
This project is indexed by GitNexus as **bank-statement-analizer** (1400 symbols, 2202 relationships, 24 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
