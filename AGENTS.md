...
This project is indexed by GitNexus as **bank-statement-analizer** (1070 symbols, 1719 relationships, 16 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
