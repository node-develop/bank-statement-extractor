...
This project is indexed by GitNexus as **bank-statement-analizer** (515 symbols, 705 relationships, 6 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
