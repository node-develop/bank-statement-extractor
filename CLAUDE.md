...
This project is indexed by GitNexus as **bank-statement-analizer** (248 symbols, 329 relationships, 4 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
