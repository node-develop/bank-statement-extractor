...
This project is indexed by GitNexus as **bank-statement-analizer** (1374 symbols, 2157 relationships, 22 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
