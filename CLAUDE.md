...
This project is indexed by GitNexus as **bank-statement-analizer** (290 symbols, 373 relationships, 4 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
