...
This project is indexed by GitNexus as **bank-statement-analizer** (1195 symbols, 1910 relationships, 20 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
