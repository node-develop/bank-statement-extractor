...
This project is indexed by GitNexus as **bank-statement-analizer** (1494 symbols, 2295 relationships, 24 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
