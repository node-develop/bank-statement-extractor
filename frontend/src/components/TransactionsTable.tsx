...
import type { Suspect, Transaction } from "../types";
      ...
      <table className="tx">
        ...
        <tbody>
          {transactions.map((tx, i) => {
            ...
            return (
              // biome-ignore lint/suspicious/noArrayIndexKey: tx rows are positional within a period and never reordered
                ...
                <td>
                  <span className={tx.direction === "credit" ? "tx-dir-credit" : "tx-dir-debit"}>
                    <span
                      ...
                      style={{
                        background:
                          tx.direction === "credit" ? "var(--success-fg)" : "var(--danger-fg)",
                      }}
                    />
                    {tx.direction}
                  </span>
